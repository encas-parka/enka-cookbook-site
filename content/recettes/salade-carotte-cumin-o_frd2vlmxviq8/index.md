...
preparation: |-
  ...
  -  Dans un saladier, versez le jus des oranges et des citrons, ajoutez l'huile d'olive, le cumin, le poivre et le sel, mélangez, puis ajoutez les carottes râpées et la coriandre, mélangez de nouveau, couvrez d'un film alimentaire et réservez au frais jusqu'au moment de servir.
prepAlt: []
astuces:
  - '{"astuce":"On peut ajouter de la fleur d''oranger "}'
preparation24h: null
permissionWrite:
