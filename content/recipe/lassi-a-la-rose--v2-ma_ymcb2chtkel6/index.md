...
regime:
  ...
  - sans-lactose
plate: 15
quantite_desc: 1 verre a moutarde/ personne
check: true
cuisson: false
serveHot: false
description: entremets onctueux frais
region: Indienne
saison:
  - ete
id: lassi-a-la-rose--v2-ma_ymcb2chtkel6
materiel: []
ingredients:
  - uuid: n85gmi
  ...
  - uuid: hlbwfd
    ...
    type: frais
preparation: |-
  Battre tous les ingrédients de base au mixer.

  Saupoudrer a la fin  une pincée de cardamome sur chaque verrine.
prepAlt: []
astuces: []
preparation24h: null
permissionWrite:
...
teams: []
status: public
rootRecipeId: lassi-a-la-rose_bbj07dhrylqu
