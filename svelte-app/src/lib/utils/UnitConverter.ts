...
export class UnitConverter {
  ...
  static normalize(
    ...
    const isCremeEpaisse =
      ingLower.includes("crème épaisse") || ingLower.includes("creme epaisse");
    ...
    const isMaizena =
      ingLower.includes("maizena") || ingLower.includes("maïzena");
    ...
    if (isCafe) {
      ...
      if (isSucre) {
        ...
        ruleKey = "cafe_cacao";
        baseUnit = "gr.";
      } else if (isSucreGlace) {
        ruleKey = "cafe_sucre_glace";
        baseUnit = "gr.";
      } else if (isMaizena) {
        ruleKey = "cafe_maizena";
        baseUnit = "gr.";
      } else if (isBicarbonate) {
        ruleKey = "cafe_bicarbonate";
        baseUnit = "gr.";
      } else if (isCurcuma) {
        ruleKey = "cafe_curcuma";
        baseUnit = "gr.";
      } else if (isCumin) {
        ruleKey = "cafe_cumin";
        baseUnit = "gr.";
        ...
        ruleKey = "cafe_muscade";
        baseUnit = "gr.";
      } else if (isPaprika) {
        ruleKey = "cafe_paprika";
        baseUnit = "gr.";
      } else if (isMiel) {
        ruleKey = "cafe_miel";
        baseUnit = "gr.";
      } else if (isCremeEpaisse) {
        ruleKey = "cafe_creme_epaisse";
        baseUnit = "ml";
      }
      ...
      if (isSucre) {
        ...
        ruleKey = "soupe_farine";
        baseUnit = "gr.";
      } else if (isSemoule) {
        ruleKey = "soupe_semoule";
        baseUnit = "gr.";
      } else if (isPoivre) {
        ruleKey = "soupe_poivre";
        baseUnit = "gr.";
      } else if (isCacao) {
        ruleKey = "soupe_cacao";
        baseUnit = "gr.";
      } else if (isSucreGlace) {
        ruleKey = "soupe_sucre_glace";
        baseUnit = "gr.";
      } else if (isMaizena) {
        ruleKey = "soupe_maizena";
        baseUnit = "gr.";
      } else if (isCremeEpaisse) {
        ruleKey = "soupe_creme_epaisse";
        baseUnit = "ml";
      } else if (isBicarbonate) {
        ruleKey = "soupe_bicarbonate";
        baseUnit = "gr.";
      } else if (isCurcuma) {
        ruleKey = "soupe_curcuma";
        baseUnit = "gr.";
      } else if (isCumin) {
        ruleKey = "soupe_cumin";
        baseUnit = "gr.";
        ...
        ruleKey = "soupe_muscade";
        baseUnit = "gr.";
      } else if (isPaprika) {
        ruleKey = "soupe_paprika";
        baseUnit = "gr.";
      } else if (isMiel) {
        ruleKey = "soupe_miel";
        baseUnit = "gr.";
